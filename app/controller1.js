...
return{
	...
	get_all_clients: function(req, res){
		...
		// setup the fabric network
		var channel = fabric_client.newChannel('client-channel');
		var peer = fabric_client.newPeer('grpc://localhost:7051');
		channel.addPeer(peer);
	...
	create_order_parsel: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        args: [sender, "", receiver, ""],   // TODO: add branch by client\s record 
		        chainId: 'parsel-channel',
		        txId: tx_id
		    };
	...
	add_client: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'clients',
		        fcn: 'addClient',
		        args: [name, address, phone, branchId],
		        chainId: 'client-channel',
		        txId: tx_id
		    };
